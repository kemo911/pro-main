	...
	<legend><?php _e('Update'); ?></legend>
		<br><div class="row">
			<?php if (!$settings->newChangelog()) : ?>
				<div class="col-md-12 alert alert-block alert-warning fade in"><a class="close" data-dismiss="alert" href="#">&times;</a><h4 class="alert-warning"><?php _e('Updates disabled'); ?></h4>
				...
				<div class="col-md-12 alert alert-block alert-info fade in"><a class="close" data-dismiss="alert" href="#">&times;</a><h4 class="alert-info"><?php _e('Update available!'); ?></h4>
				<?php _e('There\'s a new update available! Please visit your CodeCanyon profile to download the new version.'); ?></div>
				<?php else : ?>
				<div class="col-md-12 alert alert-block alert-success fade in"><a class="close" data-dismiss="alert" href="#">&times;</a><h4 class="alert-success"><?php _e('You\'re up to date!'); ?></h4>
