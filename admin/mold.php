...
if(!empty($_POST) && !empty($_SESSION['mold_id'])){
    ...
    $_SESSION['success_msg'] = 'Les modifications ont été sauvegardées.';
    flashMoldSession();
                        ...
                        <div class="form-group" style="padding: 10px 0;">
                            ...
                            <a style="width: 45%; float: right;" class="btn btn-info text-right"
                               href="/admin/client.php/"><i
                                        class="glyphicon glyphicon-plus"></i> Créer un client</a>
...
<!--                                    </select>-->
                        ...
                        <div class="input-group" style="padding: 10px 0">
                            <input type="text" placeholder="Entrez NIV" class="form-control col-md-9" name="vin" id="vin" value="<?php echo !empty($mold['vin']) ? $mold['vin'] : ''; ?>">
                            <span class="input-group-btn">
                                    <button class="btn btn-primary" id="scanVIN" type="button">Rechercher</button>
                                </span>
                        </div>
                ...
                <div class="panel panel-primary">
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group" style="padding-top: 10px;">
                                <a href="/admin/main.php" id="create-invoice-button" data-value="Create Invoice"
                                   class="btn btn-danger">+ CRÉER UNE FACTURE</a>
                        ...
                        <div class="col-md-6" style="display: none;">
                            <div>
                                <p>Je soussigné(e), assuré(e) ou représentant de l’assuré(e), déclare avoir pris
                                    connaissance des réparations de débosselage sans peinture exécuter sur mon véhicule
                                    par Eco Solution Grêle, et je m’en déclare entièrement satisfait(e).</p>
                            </div>
